...
# Calculate suitable depth and substrate type by area ---------------------
 ...
 area_nwhi_depth<-area(nwhi_depth,na.rm = TRUE)
...
depth_per_zone<-rbind(c(depth_per_zone,nwhi_depth_per_zone)) 
 ...
 nwhi_area_substrate<-area(nwhi_substrate_reproj,na.rm = TRUE)
 ...
 substrate_per_zone<-rbind(c(substrate_per_zone,nwhi_substrate_per_zone))
...
s_cells_zone<-rbind(c(s_cells_zone,nwhi_s_cells_zone))
