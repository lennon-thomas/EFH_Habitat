...
mhi_juvenile_depth[mhi_juvenile_depth>0]<-1
...
mhi_subtrate_juvenile<-mask(mhi_subtrate_juvenile,mhi_depth)
p#mhi_substrate_juvenile_area<-mask(mhi_area,mhi_subtrate_juvenile)
